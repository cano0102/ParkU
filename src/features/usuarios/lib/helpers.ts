...
import { NOMBRE_MIN, NOMBRE_MAX, PASSWORD_MIN, PASSWORD_MAX, PASSWORD_REQUISITOS, PASSWORD_AYUDA, TELEFONO_REGEX, TELEFONO_MAX, EMAIL_REGEX, quitarDigitos, filtrarTelefono, validarTelefono, validarPassword } from "@/utils/validation";
...
export { NOMBRE_MIN, NOMBRE_MAX, PASSWORD_MIN, PASSWORD_MAX, PASSWORD_REQUISITOS, PASSWORD_AYUDA, TELEFONO_REGEX, TELEFONO_MAX, EMAIL_REGEX, quitarDigitos, filtrarTelefono, validarTelefono, validarPassword };
