...
interface UsuariosResultsProps {
  ...
  /** Borra la cuenta de la base de datos, previa confirmación (useUsuarioFormState). */
...
export function UsuariosResults({
  ...
  onToggleEstado, onEdit, onDelete, documentoDe, nombreDeRolReal, fotoDe, onPageChange, onItemsPerPageChange, idUltimoAdminActivo,
  ...
  const handlers = { onToggleEstado, onEdit, onDelete, documentoDe, nombreDeRolReal, fotoDe, idUltimoAdminActivo };
