...
export {
  ...
  esDeConductor, vehiculosDeConductor, vehiculosOperables,
} from './lib/ocupacion';
...
export { validarDatosVehiculo, COLORS, getTipoVehiculoStyle, validarPlacaColombiana, validarPlacaPorTipo, tipoVehiculoDesdePlaca } from './lib/helpers';
export type { ErroresVehiculo } from './lib/helpers';
export { VehiculoView } from './components/VehiculoView';
export { VehiculoFormModal } from './components/VehiculoFormModal';
export type { VehiculoFormState } from './components/VehiculoFormModal';
