...
import { Card, SectionTitle, retraso } from "./DashboardPrimitives";
      ...
      <div className="grid gap-3 md:grid-cols-2">
        {movements.map((move, index) => {
          ...
          return (
            <div
              key={move.id}
              style={retraso(index * 40)}
              onClick={onVerTodos}
              className="anim-fade-up-sm flex cursor-pointer items-center gap-3 rounded-xl border border-[#E2E8F0] bg-[#F8FAF9] p-3 hover:bg-white hover:shadow-sm transition-all duration-200"
            >
