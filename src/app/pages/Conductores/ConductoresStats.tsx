import { ShieldCheck, Users, UserCheck, Car, Bike } from "lucide-react";

interface ConductoresStatsProps {
...
export function ConductoresStats({
  totalConductores, totalActivos, totalVehiculos, totalCarros, totalMotos,
}: ConductoresStatsProps) {
  return (
    <div
      style={{
        position: "relative",
